...
@Dependent
public class StunnerNodeFactory {
    ...
    @Inject
    public StunnerNodeFactory(final FactoryManager factoryManager) {
        DomGlobal.console.log("~~>> " + factoryManager);
    ...
    private void ddExtAugmentStunner(final Node currentNode,
        ...
        final JSIDMNShape shape = dmnShape;
